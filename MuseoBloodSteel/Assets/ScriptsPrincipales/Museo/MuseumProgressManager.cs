...
public class MuseumProgressManager : MonoBehaviour
{
    ...
    [Header("Referencias de activaci�n")]
    public Animator anim1;              // animaci�n 1 (puerta, compuerta, etc.)
    public Animator anim2;              // animaci�n 2 (otra zona o vitrina)
    ...
    /// <summary>
    /// Llama este m�todo desde OnPointerClickXR() en tus objetos del museo
    /// </summary>
    ...
    private void CheckProgress()
    {
        ...
        if (!anim1Triggered && counter >= triggerAnim1)
        {
            if (anim1)
            {
                ...
                if (debugLog) Debug.Log("Evento 1: Animaci�n 1 activada");
            }
            anim1Triggered = true;
        }
        ...
        if (!anim2Triggered && counter >= triggerAnim2)
        {
            if (anim2)
            {
                ...
                if (debugLog) Debug.Log("Evento 2: Animaci�n 2 activada");
            }
            anim2Triggered = true;
        }
